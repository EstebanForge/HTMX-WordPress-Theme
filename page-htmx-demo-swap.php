...
<main id="content" <?php post_class('container content-area'); ?>>
	<section class="page-content post-content" role="main">
		...
		<p>
			<button id="trigger-demo" hx-get="<?php echo hm_get_endpoint_url($hxtheme_data['path']); ?>" hx-vals='{"action": "demo"}' hx-swap="innerHTML" hx-target="#hxtheme-demo-swap" hx-disabled-elt="this">Click to swap with response</button>
		</p>
		<p>
